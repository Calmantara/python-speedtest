...
servers_list = [[6527],[2054]]#,[7580], [23158], [17760], [2054], [3633], [10567]]
    ...
    for i in range(len(servers_list)):
        ...
        with open('{}.csv'.format(servers_list[i][0]), 'a') as f:
            if(first_run_list[i] == 0):
                ...
                f.write('{},{},{},{},{}\n'.format((d/bit_to_megabyte), (u/bit_to_megabyte), p, c, t))
                print("Data was successfully saved in {}.csv!".format(servers_list[i][0]))
